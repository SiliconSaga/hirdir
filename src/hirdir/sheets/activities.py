...
SEED = [
    ...
    (
        ...
        "Game",
        "LK+",
        "Minnows dribble across the area; one or two sharks (coach at first) try to kick "
        "their ball out. Caught minnows become sharks.",
        "Classic",
    ),
    (
        "Coach Says (body-part touches)",
        "Warm-up",
        "LK+",
        "Simon Says with the ball: “Coach says touch it with your knee / sole / elbow!” "
        "Teaches ball control and listening.",
        "Classic",
    ),
    (
        "Pirate Treasure",
